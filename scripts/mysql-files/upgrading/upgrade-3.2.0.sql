...
ALTER TABLE `ck_playertimes` ADD `velStartXY` SMALLINT NOT NULL DEFAULT '0' AFTER `runtimepro`, ADD `velStartXYZ` SMALLINT NOT NULL DEFAULT '0' AFTER `velStartXY`, ADD `velStartZ` SMALLINT NOT NULL DEFAULT '0' AFTER `velStartXYZ`, ADD `velEndXY` SMALLINT NOT NULL DEFAULT '0' AFTER `velStartZ`, ADD `velEndXYZ` SMALLINT NOT NULL DEFAULT '0' AFTER `velEndXY`, ADD `velEndZ` SMALLINT NOT NULL DEFAULT '0' AFTER `velEndXYZ`;
